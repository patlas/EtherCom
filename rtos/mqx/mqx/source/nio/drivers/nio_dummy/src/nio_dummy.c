...
static int nio_dummy_open(void *dev_context, const char *dev_name, int flags, void **fp_context);
static int nio_dummy_read(void *dev_context, void *fp_context, void *buf, size_t nbytes);
static int nio_dummy_write(void *dev_context, void *fp_context, const void *buf, size_t nbytes);
static off_t nio_dummy_lseek(void *dev_context, void *fp_context, off_t offset, int whence);
static int nio_dummy_ioctl(void *dev_context, void *fp_context, unsigned long int request, va_list ap);
static int nio_dummy_close(void *dev_context, void *fp_context);
static int nio_dummy_init(void *init_data, void **dev_context);
static int nio_dummy_deinit(void *dev_context);
