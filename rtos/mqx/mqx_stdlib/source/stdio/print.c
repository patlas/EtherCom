...
int fprintf(FILE *stream, const char *fmt_s, ...)
{
   ...
   if ( stream )
   {
      result = _doprint(stream, fputc, -1, (char *)fmt_s, ap );
   }
   va_end(ap);
...
int printf(const char  *fmt_s, ...)
{
   ...
   va_start(ap, fmt_s);
   result = _doprint(stdout, fputc, -1, (char *)fmt_s, ap);
   va_end(ap);
...
int sprintf(char *str_ptr, const char *fmt_s, ...)
{
   ...
   va_start(ap, fmt_s);
   result = _doprint((FILE * )((void *)&str_ptr), _sputc, -1, (char *)fmt_s, ap);
   *str_ptr = '\0';
   va_end(ap);
   return result;
...
int snprintf(char *str_ptr, size_t max_count, const char *fmt_s, ...)
{
    ...
    va_list ap;
    va_start(ap, fmt_s);
    result = _doprint((FILE *)((void *)&str_ptr), _sputc, max_count, (char *)fmt_s, ap);
    va_end(ap);
    if (0 != max_count)
    {
        *str_ptr = '\0';
...
int vprintf(const char *fmt_s, va_list arg)
{
   ...
   result = _doprint(stdout, fputc, -1, (char *)fmt_s, arg);
...
int vfprintf(FILE *stream, const char *fmt_s, va_list arg)
{
   ...
   result = 0;
   if ( stream ) {
      result = _doprint(stream, fputc, -1, (char *)fmt_s, arg);
   }
   return result;
...
int vsprintf( char *str_ptr, const char *fmt_s, va_list arg)
{
   ...
   result = _doprint((FILE *)((void *)&str_ptr), _sputc, -1, (char *)fmt_s, arg);
   *str_ptr = '\0';
   return result;
...
int vsnprintf(char *str_ptr, size_t max_count, const char *fmt_s, va_list arg)
{
    ...
    result = _doprint((FILE *)((void *)&str_ptr), _sputc, max_count, (char *)fmt_s, arg);
