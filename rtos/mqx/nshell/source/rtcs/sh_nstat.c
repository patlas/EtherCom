...
/*****************************************************************************/
static uint32_t shell_netstat_print_stats(FILE *fout, void *stats_ptr, const STAT_ENTRY_STRUCT * metadata, uint32_t elements) 
{ 
    uint32_t i,count=0; 
    uint32_t *stat_ptr; 
    ...
    if (count == 0) { 
        fprintf(fout, "   0 packets sent or received\n"); 
    } 
    return count; 
} 

/*****************************************************************************/
static uint32_t shell_netstat_check_pause(FILE *fout, bool pause, uint32_t count) 
{ 
    if (pause && (count > 20))
    { 
        fprintf(fout, "---MORE---"); 
...
{ 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                if(enet)
                {
                    ...
                    count += shell_netstat_print_stats(shell_ptr->STDOUT, enet, enet_stat_entries , ELEMENTS_OF(enet_stat_entries)); 
                    count = shell_netstat_check_pause(shell_ptr->STDOUT, pause, count); 
    ...
    #if RTCSCFG_ENABLE_IP_STATS && RTCSCFG_ENABLE_IP4 
        {
            ...
            {
                fprintf(shell_ptr->STDOUT, "\nIPv4:\n"); 
                count += shell_netstat_print_stats(shell_ptr->STDOUT, ip, ip_stat_entries, ELEMENTS_OF(ip_stat_entries) ); 
                count = shell_netstat_check_pause(shell_ptr->STDOUT, pause,count); 
            }
        }
    #endif 
    ...
    #if RTCSCFG_ENABLE_IP6_STATS && RTCSCFG_ENABLE_IP6 
        {
            ...
            {
                fprintf(shell_ptr->STDOUT, "\nIPv6:\n"); 
                count += shell_netstat_print_stats(shell_ptr->STDOUT, ip6, ip6_stat_entries, ELEMENTS_OF(ip6_stat_entries) ); 
                count = shell_netstat_check_pause(shell_ptr->STDOUT, pause, count); 
            }
        }
    #endif 
        ...
        { 
            ...
            {
                fprintf(shell_ptr->STDOUT, "\nICMPv4:\n"); 
                count += shell_netstat_print_stats(shell_ptr->STDOUT, icmp, icmp_stat_entries, ELEMENTS_OF(icmp_stat_entries) ); 
                count = shell_netstat_check_pause(shell_ptr->STDOUT, pause,count); 
            }
        } 
    #endif 
        ...
        { 
            ...
            {
                fprintf(shell_ptr->STDOUT, "\nICMPv6:\n"); 
                count += shell_netstat_print_stats(shell_ptr->STDOUT, icmp6, icmp6_stat_entries, ELEMENTS_OF(icmp6_stat_entries) ); 
                count = shell_netstat_check_pause(shell_ptr->STDOUT, pause, count); 
            }
        } 
    #endif 
        ...
        { 
            ...
            {
                fprintf(shell_ptr->STDOUT, "\nUDP:\n"); 
                count += shell_netstat_print_stats(shell_ptr->STDOUT, udp, udp_stat_entries, ELEMENTS_OF(udp_stat_entries) ); 
                count = shell_netstat_check_pause(shell_ptr->STDOUT, pause, count); 
            }
        } 
    #endif 
        ...
        { 
            ...
            {
                fprintf(shell_ptr->STDOUT, "\nTCP:\n"); 
                count += shell_netstat_print_stats(shell_ptr->STDOUT, tcp, tcp_stat_entries, ELEMENTS_OF(tcp_stat_entries) ); 
                count = shell_netstat_check_pause(shell_ptr->STDOUT, pause, count); 
            }
        } 
    #endif 
    ...
    { 
        if (shorthelp)
        { 
            fprintf(shell_ptr->STDOUT, "%s [-p]\n", argv[0]); 
        } 
        else
        { 
            fprintf(shell_ptr->STDOUT, "Usage: %s [-p]\n", argv[0]); 
            fprintf(shell_ptr->STDOUT, "   -p Pause printing by pages.\n");
        } 
    } 
